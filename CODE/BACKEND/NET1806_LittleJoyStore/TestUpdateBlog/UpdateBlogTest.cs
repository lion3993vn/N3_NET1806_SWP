...
namespace TestUpdateBlog
{
    public class UpdateBlogTest
    {
        ...
        {
            var filePath = Path.Combine(TestContext.CurrentContext.TestDirectory, @"..\..\..\..\TestUpdateBlog\UpdateBlogData.csv"); //nhớ chỉnh file path
        ...
        public async Task TestUpdateBlog(BlogEntity testData)
        {
            ...
            if (testData.Testcase != "Regular user tries to update the blog")
            {
